...
r = requests.get('https://jira.fr/rest/api/2/search?jql=project = Test and summary ~ "*ProjectKey-*"&field=summary&maxResults=500',auth=('Username','Password'), verify=False)
print(r.status_code)
data = r.json()
...
pattern = re.compile("ProjectKeyUppercase-+[0-9]*|ProjectKeylowercase-+[0-9]*")
